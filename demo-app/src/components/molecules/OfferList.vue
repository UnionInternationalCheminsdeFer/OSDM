<template>
  <div class="bg-osdm-bg-secondary w-full h-full flex flex-col items-center gap-2 p-4 overflow-auto">
    <OfferCard v-for="offer in offers" :key="`trip-${offer.offerId}`" :offer="offer" class="max-w-[500px] w-2/3" />
