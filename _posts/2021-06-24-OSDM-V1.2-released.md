...
The OSDM Steering group just released the Version 1.2 of the [OSDM Specification](https://osdm.io/spec/)
as well as access to the [OSDM Sandbox](https://osdm.io/tools/sandbox/) to all interested parties.
...
See the [Release Notes 1.2](https://osdm.io//releases/OSDM-release-notes-v1.2/) for more details.
