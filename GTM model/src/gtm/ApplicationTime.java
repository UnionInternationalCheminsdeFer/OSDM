...
public class ApplicationTime {
    ...
    public String toString() {
        ...
        sb.append(ApplicationTime.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("timeUnit");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ApplicationTime) == false) {
            return false;
        }
        ApplicationTime rhs = ((ApplicationTime) other);
