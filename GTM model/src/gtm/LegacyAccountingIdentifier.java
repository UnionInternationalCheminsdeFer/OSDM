...
public class LegacyAccountingIdentifier {
    ...
    public String toString() {
        ...
        sb.append(LegacyAccountingIdentifier.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("serialId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LegacyAccountingIdentifier) == false) {
            return false;
        }
        LegacyAccountingIdentifier rhs = ((LegacyAccountingIdentifier) other);
