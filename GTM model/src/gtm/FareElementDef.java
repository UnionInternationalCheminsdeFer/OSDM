...
public class FareElementDef {
    ...
    public String toString() {
        ...
        sb.append(FareElementDef.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FareElementDef) == false) {
            return false;
        }
        FareElementDef rhs = ((FareElementDef) other);
