...
public class ConversionParamsItemProvider 
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ConversionParams_type") :
			getString("_UI_ConversionParams_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GtmPackage.Literals.CONVERSION_PARAMS__LEGACY_ZONE_MAPPINGS,
				 GtmFactory.eINSTANCE.createLegacyZoneMappings()));
