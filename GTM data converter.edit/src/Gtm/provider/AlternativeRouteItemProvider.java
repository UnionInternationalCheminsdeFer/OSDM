		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AlternativeRoute_stations_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AlternativeRoute_stations_feature", "_UI_AlternativeRoute_type"),
