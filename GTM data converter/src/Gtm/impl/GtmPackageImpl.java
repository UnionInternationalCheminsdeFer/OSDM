...
public class GtmPackageImpl extends EPackageImpl implements GtmPackage {
	 ...
	 * @generated
	 */
	private EClass legacyZoneMappingsEClass = null;
	 ...
	 * @generated
	 */
	private EClass legacyZoneMapEClass = null;
	 ...
	 * @generated
	 */
	private EClass legacyFareEClass = null;
	 ...
	 * @generated
	 */
	private EClass legacyTargetFaresEClass = null;
	 ...
	 * @generated
	 */
	private EClass includedFreePassengersEClass = null;
	 ...
	 * @generated
	 */
	public EReference getConversionParams_LegacyTargetFares() {
	 ...
	 * @generated
	 */
	public EReference getConversionParams_LegacyZoneMappings() {
	 ...
	 * @generated
	 */
	public EReference getLegacyBorderPointMapping_Station1() {
	 ...
	 * @generated
	 */
	public EReference getLegacyBorderPointMapping_Station2() {
	...
	public EReference getLegacyBorderPointMapping_ConnectionPoint() {
		return (EReference)legacyBorderPointMappingEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getZoneDefinitions_ZoneDefinitions() {
	 ...
	 * @generated
	 */
	public EClass getLegacyZoneMappings() {
		return legacyZoneMappingsEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getLegacyZoneMappings_LegacyZoneMap() {
		return (EReference)legacyZoneMappingsEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getLegacyZoneMap() {
		return legacyZoneMapEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getLegacyZoneMap_LegacyCode() {
		return (EAttribute)legacyZoneMapEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getLegacyZoneMap_Zone() {
		return (EReference)legacyZoneMapEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getLegacyFares_Fares() {
	 ...
	 * @generated
	 */
	public EClass getLegacyFare() {
		return legacyFareEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getLegacyFare_Description() {
		return (EReference)legacyFareEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getLegacy108_LegacyFares() {
	 ...
	 * @generated
	 */
	public EClass getLegacyTargetFares() {
		return legacyTargetFaresEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getLegacyTargetFares_TargetFares() {
		return (EReference)legacyTargetFaresEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getTargetFareTemplate_Price() {
	 ...
	 * @generated
	 */
	public EReference getTargetFareTemplate_RegionalConstraint() {
	...
	public EReference getTargetFareTemplate_TravelValidity() {
		return (EReference)targetFareTemplateEClass.getEStructuralFeatures().get(12);
	}
	...
	public EReference getTargetFareTemplate_CombinationConstraint() {
		return (EReference)targetFareTemplateEClass.getEStructuralFeatures().get(13);
	}
	 ...
	 * @generated
	 */
	public EReference getTargetFareTemplate_FareDetailDescription() {
		return (EReference)targetFareTemplateEClass.getEStructuralFeatures().get(14);
	}
	 ...
	 * @generated
	 */
	public EReference getTargetFareTemplate_LegacyAccountingIdentifier() {
		return (EReference)targetFareTemplateEClass.getEStructuralFeatures().get(15);
	}
	 ...
	 * @generated
	 */
	public EReference getTargetFareTemplate_PersonalDataConstraint() {
		return (EReference)targetFareTemplateEClass.getEStructuralFeatures().get(16);
	}
	 ...
	 * @generated
	 */
	public EReference getTargetFareTemplate_ReservationParameter() {
		return (EReference)targetFareTemplateEClass.getEStructuralFeatures().get(17);
	}
	 ...
	 * @generated
	 */
	public EReference getTargetFareTemplate_ReductionConstraint() {
		return (EReference)targetFareTemplateEClass.getEStructuralFeatures().get(18);
	}
	 ...
	 * @generated
	 */
	public EReference getTargetFareTemplate_FulfillmentConstraint() {
		return (EReference)targetFareTemplateEClass.getEStructuralFeatures().get(19);
	}
	 ...
	 * @generated
	 */
	public EReference getTargetFareTemplate_PassengerConstraint() {
		return (EReference)targetFareTemplateEClass.getEStructuralFeatures().get(20);
	}
	 ...
	 * @generated
	 */
	public EReference getTargetFareTemplate_AfterSalesRule() {
		return (EReference)targetFareTemplateEClass.getEStructuralFeatures().get(21);
	}
	 ...
	 * @generated
	 */
	public EReference getZone_ZoneDefinitions() {
	 ...
	 * @generated
	 */
	public EClass getIncludedFreePassengers() {
		return includedFreePassengersEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getIncludedFreePassengers_IncludedFreePassengers() {
		return (EReference)includedFreePassengersEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(zoneDefinitionsEClass, ZONE_DEFINITIONS__ZONE_DEFINITIONS);
		...
		includedFreePassengersEClass = createEClass(INCLUDED_FREE_PASSENGERS);
		createEReference(includedFreePassengersEClass, INCLUDED_FREE_PASSENGERS__INCLUDED_FREE_PASSENGERS);
		...
		createEReference(zoneEClass, ZONE__ZONE_DEFINITIONS);
		...
		createEReference(conversionParamsEClass, CONVERSION_PARAMS__LEGACY_TARGET_FARES);
		createEReference(conversionParamsEClass, CONVERSION_PARAMS__LEGACY_ZONE_MAPPINGS);
		...
		createEReference(targetFareTemplateEClass, TARGET_FARE_TEMPLATE__PRICE);
		createEReference(targetFareTemplateEClass, TARGET_FARE_TEMPLATE__REGIONAL_CONSTRAINT);
		...
		createEReference(targetFareTemplateEClass, TARGET_FARE_TEMPLATE__FARE_DETAIL_DESCRIPTION);
		createEReference(targetFareTemplateEClass, TARGET_FARE_TEMPLATE__LEGACY_ACCOUNTING_IDENTIFIER);
		createEReference(targetFareTemplateEClass, TARGET_FARE_TEMPLATE__PERSONAL_DATA_CONSTRAINT);
		createEReference(targetFareTemplateEClass, TARGET_FARE_TEMPLATE__RESERVATION_PARAMETER);
		createEReference(targetFareTemplateEClass, TARGET_FARE_TEMPLATE__REDUCTION_CONSTRAINT);
		createEReference(targetFareTemplateEClass, TARGET_FARE_TEMPLATE__FULFILLMENT_CONSTRAINT);
		createEReference(targetFareTemplateEClass, TARGET_FARE_TEMPLATE__PASSENGER_CONSTRAINT);
		createEReference(targetFareTemplateEClass, TARGET_FARE_TEMPLATE__AFTER_SALES_RULE);
		...
		createEReference(legacyBorderPointMappingEClass, LEGACY_BORDER_POINT_MAPPING__STATION1);
		createEReference(legacyBorderPointMappingEClass, LEGACY_BORDER_POINT_MAPPING__STATION2);
		...
		legacyZoneMappingsEClass = createEClass(LEGACY_ZONE_MAPPINGS);
		createEReference(legacyZoneMappingsEClass, LEGACY_ZONE_MAPPINGS__LEGACY_ZONE_MAP);

		legacyZoneMapEClass = createEClass(LEGACY_ZONE_MAP);
		createEAttribute(legacyZoneMapEClass, LEGACY_ZONE_MAP__LEGACY_CODE);
		createEReference(legacyZoneMapEClass, LEGACY_ZONE_MAP__ZONE);

		legacyFaresEClass = createEClass(LEGACY_FARES);
		createEReference(legacyFaresEClass, LEGACY_FARES__FARES);

		legacyFareEClass = createEClass(LEGACY_FARE);
		createEReference(legacyFareEClass, LEGACY_FARE__DESCRIPTION);
		...
		createEReference(legacy108EClass, LEGACY108__LEGACY_FARES);
		...
		legacyTargetFaresEClass = createEClass(LEGACY_TARGET_FARES);
		createEReference(legacyTargetFaresEClass, LEGACY_TARGET_FARES__TARGET_FARES);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDelivery_ReplacedDeliveryId(), theXMLTypePackage.getString(), "replacedDeliveryId", null, 1, 1, Delivery.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getZoneDefinitions_ZoneDefinitions(), this.getZoneDefinition(), null, "zoneDefinitions", null, 0, -1, ZoneDefinitions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPassengerConstraint_IncludedFreePassengers(), this.getIncludedFreePassengers(), null, "includedFreePassengers", null, 0, 1, PassengerConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(includedFreePassengersEClass, IncludedFreePassengers.class, "IncludedFreePassengers", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getIncludedFreePassengers_IncludedFreePassengers(), this.getPassengerCombinationConstraint(), null, "includedFreePassengers", null, 0, -1, IncludedFreePassengers.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getZone_ZoneDefinitions(), this.getZoneDefinition(), null, "zoneDefinitions", null, 0, -1, Zone.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(zoneDefinitionEClass, ZoneDefinition.class, "ZoneDefinition", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getZoneDefinition_ZoneId(), ecorePackage.getEInt(), "zoneId", null, 0, 1, ZoneDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getConversionParams_LegacyTargetFares(), this.getLegacyTargetFares(), null, "legacyTargetFares", null, 0, 1, ConversionParams.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getConversionParams_LegacyZoneMappings(), this.getLegacyZoneMappings(), null, "legacyZoneMappings", null, 0, 1, ConversionParams.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTargetFareTemplate_Price(), this.getPrice(), null, "price", null, 0, 1, TargetFareTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTargetFareTemplate_RegionalConstraint(), this.getRegionalConstraint(), null, "regionalConstraint", null, 0, 1, TargetFareTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTargetFareTemplate_FareDetailDescription(), this.getText(), null, "fareDetailDescription", null, 0, 1, TargetFareTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTargetFareTemplate_LegacyAccountingIdentifier(), this.getLegacyAccountingIdentifier(), null, "legacyAccountingIdentifier", null, 0, 1, TargetFareTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTargetFareTemplate_PersonalDataConstraint(), this.getPersonalDataConstraint(), null, "personalDataConstraint", null, 0, 1, TargetFareTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTargetFareTemplate_ReservationParameter(), this.getReservationParameter(), null, "reservationParameter", null, 0, 1, TargetFareTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTargetFareTemplate_ReductionConstraint(), this.getReductionConstraint(), null, "reductionConstraint", null, 0, 1, TargetFareTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTargetFareTemplate_FulfillmentConstraint(), this.getFulfillmentConstraint(), null, "fulfillmentConstraint", null, 0, 1, TargetFareTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTargetFareTemplate_PassengerConstraint(), this.getPassengerConstraint(), null, "passengerConstraint", null, 0, 1, TargetFareTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTargetFareTemplate_AfterSalesRule(), this.getAfterSalesRule(), null, "afterSalesRule", null, 0, 1, TargetFareTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLegacyBorderPointMapping_Station1(), this.getStation(), null, "station1", null, 0, 1, LegacyBorderPointMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLegacyBorderPointMapping_Station2(), this.getStation(), null, "station2", null, 0, 1, LegacyBorderPointMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(legacyZoneMappingsEClass, LegacyZoneMappings.class, "LegacyZoneMappings", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLegacyZoneMappings_LegacyZoneMap(), this.getLegacyZoneMap(), null, "legacyZoneMap", null, 0, -1, LegacyZoneMappings.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(legacyZoneMapEClass, LegacyZoneMap.class, "LegacyZoneMap", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLegacyZoneMap_LegacyCode(), ecorePackage.getEInt(), "legacyCode", null, 0, 1, LegacyZoneMap.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLegacyZoneMap_Zone(), this.getZone(), null, "zone", null, 0, 1, LegacyZoneMap.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(legacyFaresEClass, LegacyFares.class, "LegacyFares", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLegacyFares_Fares(), this.getLegacyFare(), null, "fares", null, 1, -1, LegacyFares.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(legacyFareEClass, LegacyFare.class, "LegacyFare", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLegacyFare_Description(), this.getLegacyDescription(), null, "description", null, 0, 5, LegacyFare.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLegacy108_LegacyFares(), this.getLegacyFares(), null, "legacyFares", null, 0, 1, Legacy108.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(legacyTargetFaresEClass, LegacyTargetFares.class, "LegacyTargetFares", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLegacyTargetFares_TargetFares(), this.getTargetFareTemplate(), null, "targetFares", null, 1, -1, LegacyTargetFares.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
