 ...
 * </p>
 * <ul>
 *   <li>{@link Gtm.impl.ConnectionPointImpl#getStations <em>Stations</em>}</li>
...
public class ConnectionPointImpl extends MinimalEObjectImpl.Container implements ConnectionPoint {
	...
	public EList<Station> getStations() {
		if (stations == null) {
			stations = new EObjectResolvingEList<Station>(Station.class, this, GtmPackage.CONNECTION_POINT__STATIONS);
		}
		return stations;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GtmPackage.CONNECTION_POINT__STATIONS:
				return getStations();
