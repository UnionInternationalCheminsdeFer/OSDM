...
| ![](../images/catalog-of-code-lists/graphics-icons/COMPARTMENT_WALL.png)         | Compartment wall                                                      | -         | `COMPARTEMENT_WALL`           | -                | -             |
| ![](../images/catalog-of-code-lists/graphics-icons/COMPARTMENT_PASSAGE.png)      | Compartment Passage                                                   | -         | `COMPARTEMENT_PASSAGE`        | -                | -             |
| ![](../images/catalog-of-code-lists/graphics-icons/COMPARTMENT_PASSAGE_LOW.png)  | Compartment Passage Low (first floor)                                 | -         | `COMPARTEMENT_PASSAGE_LOW`    | -                | -             |
| ![](../images/catalog-of-code-lists/graphics-icons/COMPARTMENT_PASSAGE_HIGH.png) | Compartment Passage High (second floor)                               | -         | `COMPARTEMENT_PASSAGE_HIGH`   | -                | -             |
| ![](../images/catalog-of-code-lists/graphics-icons/TABLE_RESTAURANT.png)         | Table in a Restaurant                                                 | -         | `TABLE_RESTAURANT`            | -                | -             |
