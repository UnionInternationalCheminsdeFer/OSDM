...
| countries                 | `urn:iso`             | `std:iso:3166` | ISO Country Codes  https://en.wikipedia.org/wiki/List_of_ISO_3166_country_codes                                                                                                                                                                                                                                                                                  | `urn:iso:std:iso:3166:CH`  | `urn:iso:std:iso:3166:`           |
| currencies                | `urn:iso`             | `std:iso:4217` | ISO Currency Codes  https://en.wikipedia.org/wiki/ISO_4217                                                                                                                                                                                                                                                                                                       | `urn:iso:std:iso:4217:CFR` | `urn:iso:std:iso:4217:`           |
