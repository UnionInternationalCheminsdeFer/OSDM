...
| `BICYCLE_AND_SEAT`                 | Y                      | Y                | Y              | Seat and a Bicycle hook. The bicycle hook might not have a number. | `SPECIAL_COMPARTMENT_TYPE`       |
...
| `PKPASS`          | pkpass file format, deprecated as of 3.8 in favour of WALLET                                |
...
| `WALLET`          | mobile ticket compatible with digital wallets such as the ones from Google or Apple         |
...
| Icon                                                                                | Description                                                           | Icon Code | Code of Graphical Element     | Orientation Used |
| ----------------------------------------------------------------------------------- | --------------------------------------------------------------------- | --------- | ----------------------------- | ---------------- |
...
| ![](../../images/catalog-of-code-lists/graphics-icons/image025.png)                 | Small wall between two compartments, height covers two places         | 26        | `T_WALL_COMPARTMENTS_2`       | top              |
...
| ![](../../images/catalog-of-code-lists/graphics-icons/COMPARTMENT_WALL.png)         | Compartment wall                                                      | -         | `COMPARTMENT_WALL`            | -                |
...
| `SWIFTWALKER`      | A swift walker (aka Dandy Horse) of a PRM                                                                                                                   | SWIFTWALKER    | X              | X              | X            |        |
