...
| `instance`      | An absolute URI that identifies the specific occurrence of the problem.                                                                                      | no            |
| `pointers`      | A list of ProblemPointer structures which provide more detail on the problem                                                                  | no            |

A ProblemPointer structure supports the following **additional** properties:
...
References to occurences in the 
...
Request for object in wrong state

``` json
"problem": {
  "code": "urn:uic:problem:BOOKING_BOOKING_ALREADY_CANCELLED",
  "type": "https://provider.domain/osdm/documentation/errors/booking_booking_already_cancelled",
  "title": "Booking is already cancelled",
  "detail": "No refund created for booking which is already cancelled",
  "instance": "/bookings/dc872758-5482-47a8-bd97-3a4cc281ad95",
  "status": 400
}
