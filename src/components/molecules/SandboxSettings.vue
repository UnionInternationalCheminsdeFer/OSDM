<template>
    <div>
        ...
        <sbb-overlay ref="overlay" accessibilitycloselabel="Close overlay" accessibilitybacklabel="Go back">
            <div class="text-osdm-text flex flex-col">
                <h1 class="self-center text-2xl mb-5">
                    Welcome to the OSDM-DEMO-APP
                </h1>
                <p class="text-md mb-5 font-normal">
                    Welcome. This model allows you to configure the used endpoint and user credentials within the demo.
                ...
                <h2 style="margin-block-end: var(--sbb-spacing-fixed-4x)">
                    Connection details for auth flow:
                </h2>
                <form class="flex flex-col gap-4 items-center">
                    <sbb-form-field error-space="none" size="m" class="w-96">
